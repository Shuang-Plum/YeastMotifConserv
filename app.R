             ...
             sidebarLayout(
               ...
               mainPanel(width=10,
                         ...
                         tabsetPanel(
                           ...
                           tabPanel("Citation",
                                    br(),
                                    tags$p(strong('If you use CoSMoS.c., please cite '), tags$a(strong('this paper:'),href = 'https://doi.org/10.1016/j.jbc.2023.104617',target='_blank')),
                                    #br(),
                                    tags$p(HTML(paste('Shuang Li, Henrik G. Dohlman<br/>', strong('Evolutionary conservation of sequence motifs at sites of protein modification'),'<br/>Journal of Biological Chemistry',HTML('&nbsp;'),HTML('&nbsp;'),'2023'))),
                                    hr(),
                                    ...
                                    hr(),
                                    tags$p('For questions or to report problems, please email: '),
                                    tags$p('shuang9@email.unc.edu; hdohlman@med.unc.edu.')
